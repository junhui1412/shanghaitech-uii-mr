...
class MANIQA(nn.Module):
    def __init__(self, embed_dim=72, num_outputs=1, patch_size=8, drop=0.1, 
        ...
        self.vit = timm.create_model('vit_base_patch8_224.augreg2_in21k_ft_in1k', pretrained=False, checkpoint_path='./model_weight/vit_base_patch8_224.augreg2_in21k_ft_in1k/model.safetensors')

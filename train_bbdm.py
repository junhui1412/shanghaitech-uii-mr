...
from src.module.bbdm.models.ConditionalNAFNet_arch import ConditionalNAFNet
...
def parse_args():
    ...
    parser.add_argument(
        ...
        type=str,
        # default=None,
        default="cfg/train_configs/train_bbdm_dists.yaml",
        # required=True,
        help="path to config",
    )

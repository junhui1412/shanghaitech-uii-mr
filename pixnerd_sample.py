...
name2seriesID = {
    'pixnerd_bbdm_noise_schedule': 1,
    'pixnerd_bbdm_noise_schedule_dists': 2,
}
    ...
    for i, batch in tqdm(enumerate(dataloader), total=len(dataloader)):
        ...
        if args.save_dicom:
            ...
            for idx in range(batch_size):
                ...
                slice_ds.SeriesInstanceUID = f'5.{name2seriesID[args.model_type]}.' + slice_ds.SeriesInstanceUID
                slice_ds.SOPInstanceUID = f'5.{name2seriesID[args.model_type]}.' + slice_ds.SOPInstanceUID

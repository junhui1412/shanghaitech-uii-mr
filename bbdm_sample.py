...
def main(args):
    ...
    # Load model:
    if args.model_type == 'bbdm_unet_64c':
        model_channels = 64
    elif args.model_type == 'bbdm_unet_128c':
        model_channels = 128
    else:
        model_channels = 256
    model = UNetModel(
...
if __name__ == "__main__":
    ...
    parser.add_argument("--ckpt", default="./runs/train_bbdm/unet_64c/checkpoints/model_ema.pt", type=str, help="Optional path to a model checkpoint.")
    parser.add_argument("--model-type", default='bbdm_unet_64c', type=str, choices=['bbdm_unet_256c', 'bbdm_unet_64c', 'bbdm_unet_128c'], help="Type of diffusion model.")
    # general
